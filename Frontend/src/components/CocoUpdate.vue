<template>
            ...
            <div class="card h-100">
              <form class="card-body custom-form" @submit.prevent="saveChocolate()">
                ...
                <div class="from-group">
                  ...
                  <input type="number" id="stock" v-model="coco.stock" :class="{ 'error': !validation.stockValid }" class="form-control custom-input">
                </div>
                <div class="form-group">
  ...
  const validation = ref({ nameValid: true, costValid: true, categoryValid: true, typeValid: true, massValid: true, descriptionValid: true, imageValid: true, stockValid: true });
